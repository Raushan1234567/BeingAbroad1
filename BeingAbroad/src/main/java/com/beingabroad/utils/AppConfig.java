	...
	public SecurityFilterChain configuration(HttpSecurity http) throws Exception {
		...
		cors(cors ->{
			cors.configurationSource(new org.springframework.web.cors.CorsConfigurationSource(){
				...
				.requestMatchers(HttpMethod.GET, "/institute/**").permitAll()
				
				.requestMatchers(HttpMethod.PUT,"/institutes/**").hasRole("ADMIN")
				
				.requestMatchers(HttpMethod.POST,"/institutes/**").hasRole("ADMIN")
